...
model_path = './segNet_model/segnet_model_driving_webdemo.prototxt'
weights_path = './segNet_model/segnet_weights_driving_webdemo.caffemodel'
colors_path = './segNet_model/camvid12.png'
...
label_colours = cv2.imread(colors_path).astype(np.uint8)
